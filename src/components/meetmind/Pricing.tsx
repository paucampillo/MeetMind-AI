...
const plans: Plan[] = [
  {
    name: "PRO",
    price: "19€",
    cadence: "/ 10 usuarios / mes",
    description: "Productividad individual potenciada con IA.",
    features: [
      "Transcripción",
      "Resúmenes IA",
      "Tareas automáticas",
  ...
  },
  {
    ...
    price: "39€",
    cadence: "/ 10 usuarios / mes",
    description: "Para equipos que colaboran y ejecutan juntos.",
    features: [
      "Todo lo de PRO",
      "Integración con Teams y Google Meet",
      "Colaboración en equipo",
      "Panel de proyectos compartido",
    ],
  ...
  },
  {
    ...
    price: "79€",
    cadence: "/ 10 usuarios / mes",
    description: "Para organizaciones con múltiples proyectos.",
    features: [
      "Todo lo de TEAM",
      "Dependencias",
